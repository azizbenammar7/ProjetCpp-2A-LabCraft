...
public:     //méthodes de la classe Arduino
    ...
    int write_equipment_id_to_arduino(QString equipmentID);
    void update_lcd_with_state(QString state); // Add this method declaration
    QString get_equipment_name_from_database(int equipmentID);
    bool store_serial_data();
    QString get_data() const {
        return data;
    }
    QString get_equipment_state_from_database(int equipmentID);
